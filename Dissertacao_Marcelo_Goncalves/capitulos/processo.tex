...
Carga de Trabalho é menor ou igual, para Métricas minimizáveis, maior ou igual, 
para Métricas maximizáveis, ao valor definido para o SLA como parte dos dados de 
entrada do Processo.
