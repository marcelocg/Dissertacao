...
\begin{description}
\scriptsize
  %\item[$P_{i}$] = $\emph{no. config. candidatas verdadeiras} / (\emph{no. config. candidatas verdadeiras}\,+\,\emph{no. config. candidatas falsas})$
  ...
  \smallskip
  %\item[$R_{i}$] = $\emph{no. config. candidatas verdadeiras} / (\emph{no. config. candidatas verdadeiras }\,+\,\emph{no. config. rejeitadas falsas})$
